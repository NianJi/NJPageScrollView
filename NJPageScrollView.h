...
{
@private
    id<NJPageScrollViewDataSource>  _dataSource;        //weak 
    id<NJPageScrollViewDelegate>    _delegate;          //weak 注意不能将delegate设为self
...
@property (nonatomic, assign)   id <NJPageScrollViewDataSource> dataSource;
@property (nonatomic, assign)   id <NJPageScrollViewDelegate>   delegate;
